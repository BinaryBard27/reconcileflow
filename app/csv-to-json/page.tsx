      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 bg-gradient-to-br from-fuchsia-500 to-pink-500 rounded-xl flex items-center justify-center">
              <span className="text-4xl">Code</span>
            </div>
            <div>
              <h1 className="text-3xl font-bold text-gray-900">CSV to JSON</h1>
              <p className="text-gray-600">Convert CSV files to JSON format</p>
            </div>
          </div>
        </div>

        <div className="bg-white border border-gray-200 rounded-xl p-8">
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-fuchsia-500 transition-colors">
            <input
              type="file"
              accept=".csv"
