...
export default function ExcelToCsvPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <PageSeo title={SEO_PAGES['excel-to-csv'].title} description={SEO_PAGES['excel-to-csv'].description} />
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Excel to CSV</h1>
              <p className="text-gray-600">Convert Excel files to CSV format</p>
            </div>
          </div>
        </div>
